...
discussed in \Cref{sec:Exc}), with a lattice parameter set at
\num{4.157} Bohr radii, or \SI{2.2}{\angstrom}.

To run this simulation, assuming that Quantum Espresso is already installed,
...
\begin{figure}[t]
\centering
\input{./assets/lattice_optimization.tex}
...
\Cref{fig:cu_cubic}. As can be seen, the lattice parameter that minimizes the
...
(FCC), as shown in \Cref{fig:fcc}. If the procedure described here were
...
The detailed code used to produce \Cref{fig:cu_cubic} is included
here. It includes
